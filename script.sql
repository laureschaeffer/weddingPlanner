...
-- Listage des données de la table weddingplanner.booking : ~18 rows (environ)
...
INSERT IGNORE INTO `project` (`id`, `user_id`, `destination_id`, `budget_id`, `state_id`, `firstname`, `surname`, `email`, `telephone`, `date_event`, `nb_guest`, `description`, `date_receipt`, `is_contacted`, `final_price`) VALUES
	...
	(3, 7, 2, 3, 1, 'Maria', 'Nomdef', NULL, '0611223344', '2025-07-30 10:00:00', 200, 'projet', '2024-07-31 11:23:53', 1, 40000),
...
-- Listage des données de la table weddingplanner.reservation : ~17 rows (environ)
