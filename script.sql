...
-- Listage des données de la table weddingplanner.comment : ~4 rows (environ)
...
-- Listage des données de la table weddingplanner.project : ~2 rows (environ)
INSERT IGNORE INTO `project` (`id`, `user_id`, `destination_id`, `budget_id`, `state_id`, `firstname`, `surname`, `email`, `telephone`, `date_event`, `nb_guest`, `description`, `date_receipt`, `is_contacted`, `final_price`) VALUES
	(1, 4, 1, 1, 2, 'Laure', 'Nom', 'laure@exemple.fr', '0611223344', '2026-05-22 15:58:43', 100, 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Est sunt, maiores ex magnam incidunt reiciendis explicabo vero laudantium, officia quae itaque laborum fugit rerum dicta quasi ', '2024-05-22 15:59:20', 1, 7000),
	(3, 2, 2, 3, 1, 'Maria', 'Nomdef', NULL, '0611223344', '2025-07-30 10:00:00', 200, 'projet', '2024-07-31 11:23:53', 0, NULL);
...
INSERT IGNORE INTO `user` (`id`, `email`, `pseudo`, `roles`, `password`, `is_verified`, `google_user`) VALUES
	...
	(4, 'person2@exemple.fr', 'Person2', '["ROLE_USER", "ROLE_ACHETEUR"]', '$2y$13$A16IcbMl8dQ5caZGlGfK1eiciuQlkPBfsI62PBmCJh4hbdTTSrPa.', 0, 0),
	(7, 'laure.15013@gmail.com', 'laure.15013', '[]', 'b1a8919eece6d1c4228b50f72834ca74', 1, 1);
