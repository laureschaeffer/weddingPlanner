...
class ResetPasswordController extends AbstractController
{
    ...
    {
        // génére un faux jeton si l'utilisateur n'existe pas ou si quelqu'un accède directement à cette page
    ...
    {
        if ($token) {
            // nous stockons le jeton en session et le supprimons de l'URL, pour éviter que l'URL ne soit chargé dans un navigateur et potentiellement divulgué le jeton à du JavaScript tiers.
        ...
        // token valid, autorise l'utilisateur à changer son mot de passe
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            // Encode(hash) le mot de passe et l'enregistre
